...
baseurl="http://waimai.meituan.com/home/ws103144h9mf?classify_type=|cate_all&price_type=0&sort_type=1&support_invoice=0&support_online_pay=0&support_logistic=0"
#目标网站URL
j=1
...
driver.find_element_by_css_selector("#bannerimg > div > a").click()
time.sleep(2)
driver.find_element_by_css_selector("#searchKeywords").send_keys("科技园金融基地")
time.sleep(4)
driver.find_element_by_css_selector("#search").click()
time.sleep(5)
driver.find_element_by_link_text("开始订餐").click()
time.sleep(5)
driver.find_element_by_css_selector("#sortFilter > a.sort.sa-sort").click()
time.sleep(2)
for i in range(1,100):
        ...
        print(name+"-"+"-"+ proceeds)
        #在控制台输出结果
w.save(r'D:\pythontest\电商\美团\餐饮商家.xlsx')
#保存到本地excel文件